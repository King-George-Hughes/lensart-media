          ...
          >
            <div>
              ...
              <h2 className="my-3 max-w-md text-[1.7rem] font-bold lg:text-4xl">
                We Are <br />
                <span className="text-primary">Lensart Media.</span>
              </h2>

              <div className="my-5 h-[1.5px] w-[40px] bg-primary" />
              <h1 className="mt-5 max-w-lg text-sm leading-loose tracking-wider text-slate-700">
              ...
              <p className="mt-5 max-w-lg text-xs leading-loose tracking-wider text-slate-500">
